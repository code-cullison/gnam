...
gm3d = gm(props,3,{'X':0,'Y':1,'Z':2},(nx,ny,nz),(dx,dy,dz),(xmin,ymin,zmin))
print('gm3d.shape:',gm3d.shape)
del props
gm3d.subsample(2,2,10)
print('gm3d.shape:',gm3d.shape)
print('gm3d[0,360:362,300:302,:]\n',gm3d[0,360:362,300:302,:])
...
surf = gm3d.depthValsSliceFromZIndex(0)[0]
print('surf.shape',surf.shape)
#surf = surf.transpose(1,0)
#print('surf.shape',surf.shape)
...
'''
slice_surf = gm3d.depthValsSliceFromXYCoordsZIndex(xy,0,local=False)[0]
